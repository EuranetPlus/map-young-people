export const config = {
	mapTitle: 'map-young-people', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-young-people.vercel.app', // The url provided when deploying the map on Vercel
